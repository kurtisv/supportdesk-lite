  ...
  return (
    <div className="min-h-screen bg-muted text-foreground">
      ...
      <div className="lg:pl-64">
        ...
        <div className="border-b bg-muted/60 px-6 py-2 text-xs text-muted-foreground flex items-center gap-4">
          <span>{t.demoBar}</span>
          <Link href="/support" className="underline-offset-4 hover:underline shrink-0">
            {t.publicForm}
          </Link>
        </div>
        {children}
